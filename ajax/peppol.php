...
/**
 *       \file       htdocs/peppolexport/ajax/peppol.php
 *       \brief      File to return Ajax response on peppol list request
 */
...
// Security check
if (!$user->hasRight('peppolexport', 'peppol', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax peppolexport/ajax/peppol.php");
